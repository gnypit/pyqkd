...
"""For window app:"""
import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QTextEdit, QPushButton, QLineEdit, QDialog
...
def set_data_rate():
    ...
    while True:
        try:
            ...
            break
    return alice_data_rate


"""Start of program"""
gain = set_gain()
data_rate = set_data_rate()
