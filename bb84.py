...
def simulation_bb84(gain=1., alice_basis_length=256, rectilinear_basis_prob=0.5, disturbance_probability=0.1,
    ...
    results = {'error rate': final_key_error_rate,
               'global time': global_time_end - global_time_start,  # relict
...
simulation_bb84(gain=0.9, alice_basis_length=498, rectilinear_basis_prob=0.3126280031217866,
                disturbance_probability=0.05, publication_probability_rectilinear=0.14328836532152622, cascade_n_passes=2)
"""
